...
for folders=2:3
%     if folders==1
%         savePath='F:\Chieco\2d tracking\20170909-nitrogen-fill_height=38mm';
%         imiPath=[savePath '\images'];        
%         coarsenPath='F:\foam coarsening\20170909-nitrogen-fill_height=38mm';
%         folder_path='104NCD80';
%         im_start=400;
%         i_start=81;
%         i_fin=742;
%         step=1;
%     end
    if folders==2
        savePath='F:\Chieco\2d tracking\20170911-nitrogen-fill_height=38mm';
        imiPath=[savePath '\images'];        
        coarsenPath='F:\foam coarsening\20170911-nitrogen-fill_height=38mm';
        folder_path='104NCD80';
        im_start=400;
        i_start=822;
        i_fin=849;
    ...
    if folders==3
        savePath='F:\Chieco\2d tracking\20170912-nitrogen-fill_height=38mm';
        imiPath=[savePath '\images'];        
        coarsenPath='F:\foam coarsening\20170912-nitrogen-fill_height=38mm';
        folder_path='105NCD80';
        im_start=400;
        i_start=0;
        i_fin=667;
        step=1;        
    ...
    for i1=i_start:step:i_fin
        ...
        if i1==i_start
            vert_name=im_name;
            walkerPath=['F:\foam coarsening\20170909-nitrogen-fill_height=38mm\104NCD80\DSC_0600.JPG'];
