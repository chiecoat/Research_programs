...
for folders=1:1
    if folders==1
        savePath='F:\Chieco\2d tracking\20180224-nitrogen-fill_height=53mm';
        imiPath=[savePath '\images'];        
        coarsenPath='F:\foam coarsening\20180224-nitrogen-fill_height=53mm';
        folder_path='DSC images';
        im_start=21929;
        i_start=755;
        i_fin=1039;
        step=1;
    ...
    for i1=i_start:step:i_fin
        ...
        if i1==i_start
            vert_name=im_name;
            walkerPath=['F:\foam coarsening\20180224-nitrogen-fill_height=53mm\DSC images\DSC_21949.jpg'];
