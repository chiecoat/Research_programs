...
savePath='F:\Chieco\2d tracking\20181018-nitrogen_zoom_test';
imiPath=['F:\Chieco\2d tracking\20181018-nitrogen_zoom_test\images'];
imi_list=[4253:4533];
for i1=1:numel(imi_list)
    ...
    if i1==1
        vert_name=im_name;
        walkerPath=['F:\foam coarsening\20181018 zoom_test\DSC images\DSC_3126.jpg'];
    ...
    vertexPath=['F:\foam coarsening\20181018 zoom_test\skeleton images\' im_name ' skel.png' ];
...
%     imshow(rgb);
    ...
    foamPath=['F:\foam coarsening\20181018 zoom_test\DSC images\' im_name '.jpg'];
    % read image file
